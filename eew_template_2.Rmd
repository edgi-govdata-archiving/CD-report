...
enforcementfinegraph <- enforcement %>% ggplot()+
  geom_point(aes(x=factor(Date),y=Amount, color=President, group=1), show.legend=FALSE)+
  scale_color_viridis(discrete=TRUE)+
  geom_line(aes(x=factor(Date),y=Amount, color=President, group=1), show.legend = FALSE)+
  labs(y="Fines ($)", x="Year")+
