...
```
<div class="container">
  <img src="ma4_maalvika.jpg" alt="Snow" style="width:100%;">
...
```
<h2><span style="color:#00bfff">Under the Clean Water Act, the most well-reported regulation, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in MA4, were in violation for at least 25% of the last 3 years.</span></h2>
...
<h2><span style="color:#DC143C">There are `r activefacilities[1,2] ` 
...
<h2><span style="color:#DC143C">There are `r activefacilities[2,2] ` 
...
<h2><span style="color:#DC143C">There are `r activefacilities[3,2] ` 
...
<h2><span style="color:#DC143C">There are `r activefacilities[4,2] ` 
