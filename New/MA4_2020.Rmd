...
filenames = list.files(here("CD_Dirs/MA4"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/MA4", i)))
}
...
MA4 <- housemembers[which(housemembers$CD=="MA4"), ]
...
##### Massachusetts's 4th District; seat held by `r MA4[1,2]` since `r MA4[1,8]` 
 <div class="container">
  <img src="../CD_maps/MA4_map.png" alt="Snow" style="width:100%;">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="MA4", "MA4", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="MA4", "MA4", "Other")
...
MA4_dot <- CWAper1000[which(CWAper1000$CD.State=="MA4"), ]
...
ggsave("dotplot_MA4.png", dotplot, path=here("CD_Dirs/MA4"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/MA4/dotplot_MA4.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In MA4, there were <span style="color:#569b5e">`r MA4_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_MA-4`
...
```
# Highlights for Massachusetts's 4th District
...
names(`inspectionsper1000_All_pg4_MA-091820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_MA-091820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_MA-091820.csv`, `inspectionsper1000_All_pg4_MA-4`)
...
names(`violationsper1000_All_pg4_MA-091820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_MA-091820.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_MA-091820.csv`, `violationsper1000_All_pg4_MA-4`)
...
CAAbadactors <- `noncomp_CAA_pg6_MA-4`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_MA-4`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_MA-4`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/MA4"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/MA4"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/MA4"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/MA4/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MA4/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MA4/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/MA4_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r MA4[1,2]`](`r MA4[1,9]`) (`r MA4[1,3]`)</h2>

## In office since `r MA4[1,6]` `r MA4[1,7]`, `r MA4[1,8]`
...
<h4><span style="padding-left:30px">[`r MA4[1,10]`](`r MA4[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MA4[1,12]`](`r MA4[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MA4[1,14]`](`r MA4[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MA4[1,16]`](`r MA4[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/MA4_2020.pdf)
