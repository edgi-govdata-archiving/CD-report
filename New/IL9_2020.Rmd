...
filenames = list.files(here("CD_Dirs/IL9"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/IL9", i)))
}
...
IL9 <- housemembers[which(housemembers$CD=="IL9"), ]
...
##### Illinois's 9th District; seat held by `r IL9[1,2]` since `r IL9[1,8]` 
 <div class="container">
  <img src="../CD_maps/IL9_map.png" alt="Snow" style="width:100%;">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="IL9", "IL9", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="IL9", "IL9", "Other")
...
IL9_dot <- CWAper1000[which(CWAper1000$CD.State=="IL9"), ]
...
ggsave("dotplot_IL9.png", dotplot, path=here("CD_Dirs/IL9"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/IL9/dotplot_IL9.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In IL9, there were <span style="color:#569b5e">`r IL9_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_IL-9`
...
```
# Highlights for Illinois's 9th District
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_IL-091820.csv`, `inspectionsper1000_All_pg4_IL-9`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_IL-091820.csv`, `violationsper1000_All_pg4_IL-9`)
...
CAAbadactors <- `noncomp_CAA_pg6_IL-9`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_IL-9`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_IL-9`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/IL9"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/IL9"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/IL9"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/IL9/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/IL9/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/IL9/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/IL9_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r IL9[1,2]`](`r IL9[1,9]`) (`r IL9[1,3]`)</h2>

## In office since `r IL9[1,6]` `r IL9[1,7]`, `r IL9[1,8]`
...
<h4><span style="padding-left:30px">[`r IL9[1,10]`](`r IL9[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r IL9[1,12]`](`r IL9[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r IL9[1,14]`](`r IL9[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r IL9[1,16]`](`r IL9[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/IL9_2020.pdf)
