...
filenames = list.files(here("CD_Dirs/MO7"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/MO7", i)))
}

activefacilities <- `active-facilities_All_pg3_MO-7`
...
MO7 <- housemembers[which(housemembers$CD=="MO7"), ]
...
##### Missouri's 7th District; seat held by `r MO7[1,2]` since `r MO7[1,8]` 
 <div class="container">
  <img src="../CD_maps/MO7_map.png" alt="Snow" style="width:100%;">
...
CWAviolations <- `violations_CWA_pg6_MO-7`
...
enforcement <- `enforcements_All_pg3_MO-7`
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="MO7", "MO7", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="MO7", "MO7", "Other")
...
MO7_dot <- CWAper1000[which(CWAper1000$CD.State=="MO7"), ]
...
ggsave("dotplot_MO7.png", dotplot, path=here("CD_Dirs/MO7"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/MO7/dotplot_MO7.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In MO7, there were <span style="color:#569b5e">`r MO7_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#ok so We'll put the % in the title for the state, and try to figure out the same for MO 7
CAArecurring <- `recurring-violations_All_pg3_MO-7`[-c(2,3,5,6),]
...
CAArecurring[2,1] <- as.character("MO 7")
CAArecurring$Region2 <- as.character("All of OR")
CAArecurring[2,4] <- as.character("MO 7")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_MO-7`
...
#[9:11,2] Obama
# [17:19,2] Trump
inspections <- `inspections_All_pg3_MO-7`
...
```
# Highlights for Missouri's 7th District
...
names(`inspectionsper1000_All_pg4_MO-091820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_MO-091820.csv`$Region <- as.factor("State")
names(`inspectionsper1000_All_pg4_MO-7`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_MO-7`$Region <- as.factor("Congressional District")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_MO-091820.csv`, `inspectionsper1000_All_pg4_MO-7`)
...
names(`violationsper1000_All_pg4_MO-091820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_MO-091820.csv`$Region <- as.factor("State")
names(`violationsper1000_All_pg4_MO-7`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_MO-7`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_MO-091820.csv`, `violationsper1000_All_pg4_MO-7`)
...
CAAbadactors <- `noncomp_CAA_pg6_MO-7`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_MO-7`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_MO-7`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/MO7"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/MO7"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/MO7"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/MO7/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MO7/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MO7/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
#clean up data
CAAviolations <- `violations_CAA_pg5_MO-7` 
...
#clean up data
CAAinspections <- `inspections_CAA_pg5_MO-7`
...
#clean up data
CAAenforcement <- `enforcements_CAA_pg5_MO-7`
...
#clean up data
CWAinspections <- `inspections_CWA_pg6_MO-7`
...
#clean up data
CWAenforcement <- `enforcements_CWA_pg6_MO-7`
...
#clean up data
RCRAviolations <- `violations_RCRA_pg7_MO-7`
...
#clean up data
RCRAinspections <- `inspections_RCRA_pg7_MO-7`
...
#clean up data
RCRAenforcement <- `enforcements_RCRA_pg7_MO-7`
...
<br />
<a ><img src="../CD_images/MO7_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r MO7[1,2]`](`r MO7[1,9]`) (`r MO7[1,3]`)</h2>

## In office since `r MO7[1,6]` `r MO7[1,7]`, `r MO7[1,8]`
...
<h4><span style="padding-left:30px">[`r MO7[1,10]`](`r MO7[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MO7[1,12]`](`r MO7[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MO7[1,14]`](`r MO7[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r MO7[1,16]`](`r MO7[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/MO7_2020.pdf)
