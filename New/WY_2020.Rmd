...
filenames = list.files(here("State_Dirs/WY"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("State_Dirs/WY", i)))
}
...
WY <- senators[which(senators$state=="WY"), ]
...
##### Wyoming; seat held by `r WY[1,2]` since `r WY[1,8]` 
 <div class="container">
  <img src="../State_maps/WY_map.png" alt="Snow" style="width:100%;">
  </div>
...
ggsave("dotplot_WY.png", dotplot, path=here("State_Dirs/WY"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../State_Dirs/WY/dotplot_WY.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for WY
CWArecurring <- `recurring-violations_All_pg3_WY`[-c(1,3),]
...
`inspectionsper1000_All_pg4_WY`$Region <- as.factor("State")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_WY`)
...
`violationsper1000_All_pg4_WY`$Region <- as.factor("State")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_WY`)
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("State_Dirs/WY"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("State_Dirs/WY"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("State_Dirs/WY"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../State_Dirs/WY/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../State_Dirs/WY/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../State_Dirs/WY/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/WY_sen.png" style="float: left; width: 25%; margin-right: 5%" ></a>
