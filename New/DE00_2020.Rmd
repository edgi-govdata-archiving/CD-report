...
DE <- housemembers[which(housemembers$CD=="DE"), ]
...
##### Deleware's Congressional District; seat held by `r DE[1,2]` since `r DE[1,8]` 
 <div class="container">
...
<br />
<a ><img src="../CD_images/DE_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>
