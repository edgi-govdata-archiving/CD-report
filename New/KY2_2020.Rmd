...
filenames = list.files(here("CD_Dirs/KY2"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/KY2", i)))
}
...
KY2 <- housemembers[which(housemembers$CD=="KY2"), ]
...
##### Kentucky's 2nd District; seat held by `r KY2[1,2]` since `r KY2[1,8]` 
 <div class="container">
  <img src="../CD_maps/KY2_map.png" alt="Snow" style="width:100%;">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="KY2", "KY2", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="KY2", "KY2", "Other")
...
KY2_dot <- CWAper1000[which(CWAper1000$CD.State=="KY2"), ]
...
ggsave("dotplot_KY2.png", dotplot, path=here("CD_Dirs/KY2"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/KY2/dotplot_KY2.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In KY2, there were <span style="color:#569b5e">`r KY2_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_KY-2`
...
names(`inspectionsper1000_All_pg4_KY-091820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_KY-091820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_KY-091820.csv`, `inspectionsper1000_All_pg4_KY-2`)
...
names(`violationsper1000_All_pg4_KY-091820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_KY-091820.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_KY-091820.csv`, `violationsper1000_All_pg4_KY-2`)
...
CAAbadactors <- `noncomp_CAA_pg6_KY-2`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_KY-2`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_KY-2`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/KY2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/KY2"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/KY2"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/KY2/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/KY2/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/KY2/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/KY2_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r KY2[1,2]`](`r KY2[1,9]`) (`r KY2[1,3]`)</h2>

## In office since `r KY2[1,6]` `r KY2[1,7]`, `r KY2[1,8]`
...
<h4><span style="padding-left:30px">[`r KY2[1,10]`](`r KY2[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r KY2[1,12]`](`r KY2[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r KY2[1,14]`](`r KY2[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r KY2[1,16]`](`r KY2[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/KY2_2020.pdf)
