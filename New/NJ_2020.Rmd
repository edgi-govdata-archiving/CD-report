...
filenames = list.files(here("State_Dirs/NJ"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("State_Dirs/NJ", i)))
}
...
##### New Jersey; seat held by `r NJ[1,2]` since `r NJ[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="NJ", "NJ", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="NJ", "NJ", "Other")
...
ggsave("dotplot_NJ.png", dotplot, path=here("State_Dirs/NJ"), scale = 2, width=8, height=5, units=c("cm"))
...
<h3>In NJ, there were <span style="color:#569b5e">`r NJ_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("State_Dirs/NJ"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("State_Dirs/NJ"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("State_Dirs/NJ"), scale = 3, width=7, height=4, units=c("cm"))
...
<a ><img src="../State_Dirs/NJ/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
## In office since `r NJ[1,6]` `r NJ[1,7]`, `r NJ[1,8]`
