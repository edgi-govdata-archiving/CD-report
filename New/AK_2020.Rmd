...
filenames = list.files(here("State_Dirs/AK"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("State_Dirs/AK", i)))
}
...
##### Alaska; seat held by `r AK[1,2]` since `r AK[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="AK", "AK", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="AK", "AK", "Other")
...
<a ><img src="../State_Dirs/AK/dotplot_AK.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In AK, there were <span style="color:#569b5e">`r AK_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
`inspectionsper1000_All_pg4_AK`$Region <- as.factor("State")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_AK`)
...
`violationsper1000_All_pg4_AK`$Region <- as.factor("State")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_AK`)
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("State_Dirs/AK"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("State_Dirs/AK"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("State_Dirs/AK"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../State_Dirs/AK/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../State_Dirs/AK/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../State_Dirs/AK/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
## In office since `r AK[1,6]` `r AK[1,7]`, `r AK[1,8]`
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/AK_2020.pdf)
