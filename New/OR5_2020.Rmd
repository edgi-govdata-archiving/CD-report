...
filenames = list.files(here("CD_Dirs/OR5"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/OR5", i)))
}

activefacilities <- `active-facilities_All_pg3_OR-5`
...
OR5 <- housemembers[which(housemembers$CD=="OR5"), ]
...
##### Oregon's 5th District; seat held by `r OR5[1,2]` since `r OR5[1,8]` 
 <div class="container">
  <img src="../CD_maps/OR5_map.png" alt="Snow" style="width:100%;">
...
CWAviolations <- `violations_CWA_pg6_OR-5`
...
enforcement <- `enforcements_All_pg3_OR-5`
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="OR5", "OR5", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="OR5", "OR5", "Other")
...
OR5_dot <- CWAper1000[which(CWAper1000$CD.State=="OR5"), ]
...
ggsave("dotplot_OR5.png", dotplot, path=here("CD_Dirs/OR5"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/OR5/dotplot_OR5.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In OR5, there were <span style="color:#569b5e">`r OR5_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#ok so We'll put the % in the title for the state, and try to figure out the same for OR 5
CAArecurring <- `recurring-violations_All_pg3_OR-5`[-c(2,3,5,6),]
...
CAArecurring[2,1] <- as.character("OR 5")
CAArecurring$Region2 <- as.character("All of OR")
CAArecurring[2,4] <- as.character("OR 5")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_OR-5`
...
#[9:11,2] Obama
# [17:19,2] Trump
inspections <- `inspections_All_pg3_OR-5`
...
```
# Highlights for Oregon's 5th District
...
names(`inspectionsper1000_All_pg4_OR-5`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_OR-5`$Region <- as.factor("Congressional District")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_OR-091820.csv`, `inspectionsper1000_All_pg4_OR-5`)
...
names(`violationsper1000_All_pg4_OR-5`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_OR-5`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_OR-091820.csv`, `violationsper1000_All_pg4_OR-5`)
...
CAAbadactors <- `noncomp_CAA_pg6_OR-5`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_OR-5`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_OR-5`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/OR5"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/OR5"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/OR5"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/OR5/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/OR5/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/OR5/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
#clean up data
CAAviolations <- `violations_CAA_pg5_OR-5` 
...
#clean up data
CAAinspections <- `inspections_CAA_pg5_OR-5`
...
#clean up data
CAAenforcement <- `enforcements_CAA_pg5_OR-5`
...
#clean up data
CWAinspections <- `inspections_CWA_pg6_OR-5`
...
#clean up data
CWAenforcement <- `enforcements_CWA_pg6_OR-5`
...
#clean up data
RCRAviolations <- `violations_RCRA_pg7_OR-5`
...
#clean up data
RCRAinspections <- `inspections_RCRA_pg7_OR-5`
...
#clean up data
RCRAenforcement <- `enforcements_RCRA_pg7_OR-5`
...
<br />
<a ><img src="../CD_images/OR5_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r OR5[1,2]`](`r OR5[1,9]`) (`r OR5[1,3]`)</h2>

## In office since `r OR5[1,6]` `r OR5[1,7]`, `r OR5[1,8]`
...
<h4><span style="padding-left:30px">[`r OR5[1,10]`](`r OR5[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r OR5[1,12]`](`r OR5[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r OR5[1,14]`](`r OR5[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r OR5[1,16]`](`r OR5[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/OR5_2020.pdf)
