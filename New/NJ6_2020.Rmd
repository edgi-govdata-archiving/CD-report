...
filenames = list.files(here("CD_Dirs/NJ6"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/NJ6", i)))
}
...
NJ6 <- housemembers[which(housemembers$CD=="NJ6"), ]
...
##### New Jersey's 6th District; seat held by `r NJ6[1,2]` since `r NJ6[1,8]` 
 <div class="container">
  <img src="../CD_maps/NJ6_map.png" alt="Snow" style="width:100%;">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="NJ6", "NJ6", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="NJ6", "NJ6", "Other")
...
NJ6_dot <- CWAper1000[which(CWAper1000$CD.State=="NJ6"), ]
...
ggsave("dotplot_NJ6.png", dotplot, path=here("CD_Dirs/NJ6"), scale = 2, width=8, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/NJ6/dotplot_NJ6.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In NJ6, there were <span style="color:#569b5e">`r NJ6_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_NJ-6`
...
names(`inspectionsper1000_All_pg4_NJ-091820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_NJ-091820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_NJ-091820.csv`, `inspectionsper1000_All_pg4_NJ-6`)
...
names(`violationsper1000_All_pg4_NJ-091820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_NJ-091820.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_NJ-091820.csv`, `violationsper1000_All_pg4_NJ-6`)
...
CAAbadactors <- `noncomp_CAA_pg6_NJ-6`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_NJ-6`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_NJ-6`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/NJ6"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/NJ6"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/NJ6"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/NJ6/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/NJ6/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/NJ6/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/NJ6_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r NJ6[1,2]`](`r NJ6[1,9]`) (`r NJ6[1,3]`)</h2>

## In office since `r NJ6[1,6]` `r NJ6[1,7]`, `r NJ6[1,8]`
...
<h4><span style="padding-left:30px">[`r NJ6[1,10]`](`r NJ6[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NJ6[1,12]`](`r NJ6[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NJ6[1,14]`](`r NJ6[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NJ6[1,16]`](`r NJ6[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/NJ6_2020.pdf)
