...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="FL9", "FL9", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="FL9", "FL9", "Other")
...
ggsave("dotplot_FL9.png", dotplot, path=here("CD_Dirs/FL9"), scale = 2, width=8, height=5, units=c("cm"))
...
<h3>In FL9, there were <span style="color:#569b5e">`r FL9_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
```
# Highlights for Florida's 9th District
...
## In office since `r FL9[1,6]` `r FL9[1,7]`, `r FL9[1,8]`
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/FL9_2020.pdf)
