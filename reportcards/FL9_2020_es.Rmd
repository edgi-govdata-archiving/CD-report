...
##### El 9$^\circ$ distrito de Florida; asiento ocupado por `r FL9[1,2]` desde `r FL9[1,8]` 
 <div class="container">
...
CWAviolations <- `violations_CWA_pg6_FL-9`
...
enforcement <- `enforcements_All_pg3_FL-9`
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="FL9", "FL9", "otros CDs/\nestados")
...
FL9_dot <- CWAper1000[which(CWAper1000$CD.State=="FL9"), ]
...
ggsave("dotplot_FL9.png", dotplot, path=here("../CD_Dirs/FL9"), scale = 2, width=9, height=5, units=c("cm"))

```
 
<a ><img src="../CD_Dirs/FL9/dotplot_FL9.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>En FL9, hubo <span style="color:#569b5e">`r FL9_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
#ok so We'll put the % in the title for the state, and try to figure out the same for FL 9
CAArecurring <- `recurring-violations_All_pg3_FL-9`[-c(2,3,5,6),]
...
CAArecurring[2,1] <- as.character("FL 9")
CAArecurring$Region2 <- as.character("All of OR")
CAArecurring[2,4] <- as.character("FL 9")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_FL-9`
...
#[9:11,2] Obama
# [17:19,2] Trump
inspections <- `inspections_All_pg3_FL-9`
...
```
# ASPECTOS DESTACADOS DEL 9$^\circ$ DISTRITO DE FLORIDA
...
names(`inspectionsper1000_All_pg4_FL-9`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_FL-9`$Region <- as.factor("Congressional District")
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_FL-091820.csv`, `inspectionsper1000_All_pg4_FL-9`)
...
names(`violationsper1000_All_pg4_FL-9`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_FL-9`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_FL-091820.csv`, `violationsper1000_All_pg4_FL-9`)
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/FL9/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/FL9/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/FL9/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
#clean up data
CAAviolations <- `violations_CAA_pg5_FL-9` 
...
#clean up data
CAAinspections <- `inspections_CAA_pg5_FL-9`
...
#clean up data
CAAenforcement <- `enforcements_CAA_pg5_FL-9`
...
#clean up data
CWAinspections <- `inspections_CWA_pg6_FL-9`
...
#clean up data
CWAenforcement <- `enforcements_CWA_pg6_FL-9`
...
#clean up data
RCRAviolations <- `violations_RCRA_pg7_FL-9`
...
#clean up data
RCRAinspections <- `inspections_RCRA_pg7_FL-9`
...
#clean up data
RCRAenforcement <- `enforcements_RCRA_pg7_FL-9`
...
<br />
<a ><img src="../CD_images/FL9_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r FL9[1,2]`](`r FL9[1,9]`) (`r FL9[1,3]`)</h2>

## Ha estado en esta oficina `r FL9[1,6]` `r FL9[1,7]`, `r FL9[1,8]`
...
<h4><span style="padding-left:30px">[`r FL9[1,10]`](`r FL9[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r FL9[1,12]`](`r FL9[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r FL9[1,14]`](`r FL9[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r FL9[1,16]`](`r FL9[1,17]`)</span></h4>
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/FL9_2020.pdf)
