...
##### Vermont's Congressional District; seat held by `r VT[1,2]` since `r VT[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="VT00", "VT", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="VT00", "VT", "Other")
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/VT00_2020.pdf)
