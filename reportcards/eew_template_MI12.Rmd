...
filenames = list.files(here("MI12"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("MI12", i)))
}
...
```
 <div class="container">
  <img src="../MI12/MI12_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">Michigan's 12th District</div>
  <div class="middle-left">Seat held by Debbie Dingell since 2015</div>
  <div class="bottom-left">Report Generated 8 September 2020</div>
</div>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_MI-12`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in MI12, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_MI-090820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_MI-090820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_MI-090820.csv`, `inspectionsper1000_All_pg4_MI-12`)
...
names(`violationsper1000_All_pg4_MI-090820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_MI-090820.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_MI-090820.csv`, `violationsper1000_All_pg4_MI-12`)
...
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}
#clean up data
#CWAviolations <- read.csv(here("MI12/violations_CWA_pg6_MI-12-090820.csv"), 
                          #header=FALSE)
...
<a ><img src="../MI12/debbie_dingell.png" style="float: left; width: 25%; margin-right: 5%" ></a>

<h2><span style="color:#C21807">Democrat</span></h2>
## In office since January 6, 2015
