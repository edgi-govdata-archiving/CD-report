...
filenames = list.files(here("DE"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("DE", i)))
}
...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/DE/DE_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">Deleware at large  District</div>
  <div class="middle-left">Seat held by Lisa Rochester since 2017</div>
...
RCRArecurring[2,4] <- as.character("DE")> pagedown::chrome_print("reportcards/eew_template_DE.Rmd")
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_DE`
...
enforcementfinegraph <- enforcement %>% ggplot()+
  ...
  theme(axis.text.x=element_text(size=9),axis.title.x = element_blank())
```
# Highlights for Deleware at large  District
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in DE, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_DE-090820.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_DE-090820.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_DE-090820.csv`, `inspectionsper1000_All_pg4_DE`)
...
names(`violationsper1000_All_pg4_DE-090820.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_DE-090820.csv`$Region <- as.factor("State")
names(`violationsper1000_All_pg4_DE`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_DE`$Region <- as.factor("Congressional District")
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_DE-090820.csv`, `violationsper1000_All_pg4_DE`)
...
#clean up data
#CWAviolations <- read.csv(here("DE/violations_CWA_pg6_DE-090820.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/DE/lisa_rochester.png" style="float: left; width: 25%; margin-right: 5%" ></a>
