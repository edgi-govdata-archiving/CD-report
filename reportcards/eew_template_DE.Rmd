...
```
 <div class="container">
  ...
  <div class="top-left">Delaware at large </div>
...
##CAA RECURRING DOES NOT WORK FOR STATEWIDE YET B/C WE DO NOT USE IT
...
##first let's fix up the data
#ok so We'll put the % in the title for the state, and try to figure out the same for DE
##RCRA RECURRING DOES NOT WORK FOR STATEWIDE YET B/C WE DO NOT USE IT
...
enforcementfinegraph <- enforcement %>% ggplot()+
  ...
  theme(axis.text.x=element_text(size=9),axis.title.x = element_blank())
```
# Highlights for Delaware at large
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[1,2]` facilities, representing `r CWArecurring[1,3]`% of all regulated facilities in DE, were in violation for at least 25% of the last 3 years.</h2>
...
inspect1000bar <- ggplot(inspectionsper1000, aes(fill=Region, y=Inspectionsper1000, x=Program))+
  ...
  scale_fill_manual(values=c("#999999" , "#d43a69"))+
