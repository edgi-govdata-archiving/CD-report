...
filenames = list.files(here("LA2"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("LA2", i)))
}
...
```
 <div class="container">
  <img src="../LA2/LA2_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">Louisiana's 2nd District</div>
  <div class="middle-left">Seat held by Cedric Richmond since 2011</div>
...
#ok so We'll put the % in the title for the state, and try to figure out the same forLA 2
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_LA-2`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in LA2, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_LA-090920.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_LA-090920.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_LA-090920.csv`, `inspectionsper1000_All_pg4_LA-2`)
...
names(`violationsper1000_All_pg4_LA-090920.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_LA-090920.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_LA-090920.csv`, `violationsper1000_All_pg4_LA-2`)
...
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}
#clean up data
#CWAviolations <- read.csv(here("LA2/violations_CWA_pg6_LA-2-090920.csv"), 
                          #header=FALSE)
...
<a ><img src="../LA2/cedric_richmond.png" style="float: left; width: 25%; margin-right: 5%" ></a>

<h2><span style="color:#25539f">Democrat</span></h2>
## In office since January 5, 2011

## Relevant Committee Membership:  
<br />
<br />
###House Committee on Homeland Security
Cybersecurity, Infrastructure Protection and Innovation subcommittee - Chair

###House Committee on the Judiciary
Courts, Intellectual Property, and the Internet, Crime, Terrorism and Homeland Security subcommittees
