...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/CA52"), scale = 3, width=7, height=4, units=c("cm"))
...
```
<a ><img src="../CD_Dirs/CA52/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
