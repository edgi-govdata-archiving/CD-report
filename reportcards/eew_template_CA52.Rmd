...
filenames = list.files(here("CA52"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CA52", i)))
}
...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/CA52/CA52_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">California's 52nd District</div>
  <div class="middle-left">Seat held by Scott Peters since 2013</div>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_CA-52`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in CA52, were in violation for at least 25% of the last 3 years.</h2>
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CA-090220.csv`, `inspectionsper1000_All_pg4_CA-52`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CA-090220.csv`, `violationsper1000_All_pg4_CA-52`)
...
#clean up data
#CWAviolations <- read.csv(here("CA52/violations_CWA_pg6_CA-52-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/CA52/scott_peters.png" style="float: left; width: 25%; margin-right: 5%" ></a>
