...
##### Iowa's 2nd District; seat held by `r IA2[1,2]` since `r IA2[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="IA2", "IA2", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="IA2", "IA2", "Other")
...
<h3>In IA2, there were <span style="color:#569b5e">`r IA2_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
```
# Highlights for Iowa's 2nd District
...
```
<a ><img src="../CD_Dirs/IA2/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/IA2/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/IA2/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
## In office since `r IA2[1,6]` `r IA2[1,7]`, `r IA2[1,8]`
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/IA2_2020.pdf)
