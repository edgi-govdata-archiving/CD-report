...
##### El 6$^\circ$ distrito de New Jersey; asiento ocupado por `r NJ6[1,2]` desde `r NJ6[1,8]` 
 <div class="container">
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="NJ6", "NJ6", "otros CDs/\nestados")
...
ggsave("dotplot_NJ6.png", dotplot, path=here("../CD_Dirs/NJ6"), scale = 2, width=9, height=5, units=c("cm"))
...
<h3>En NJ6, hubo <span style="color:#569b5e">`r NJ6_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
```
# ASPECTOS DESTACADOS DEL 6$^\circ$ DISTRITO DE NEW JERSEY
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/NJ6/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/NJ6/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/NJ6/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
## Ha estado en esta oficina `r NJ6[1,6]` `r NJ6[1,7]`, `r NJ6[1,8]`
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/NJ6_2020.pdf)
