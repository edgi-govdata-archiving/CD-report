...
filenames = list.files(here("SC3"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("SC3", i)))
}
...
```
 <div class="container">
  <img src="/Users/colealder/Documents/CD-report/SC3/SC3_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">South Carolina's 3rd District</div>
  <div class="middle-left">Seat held by Jeff Duncan since 2011</div>
...
<a href="https://www.environmentalenforcementwatch.org/"><img src="/Users/colealder/Documents/CD-report/reportcards/eew_logo.png" style="float: left; width: 15%; margin-left: 20%" ></a>
<a href="https://envirodatagov.org/"><img src="/Users/colealder/Documents/CD-report/reportcards/edgi_logo.png" style="float: right; width: 25%; margin-right: 20%" ></a>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_SC-3`
...
* <h2>Comparing the first 3 years of the Obama administration to the first 3 years of the Trump administration, there has been `r inspectionchange[1,3]`% change in inspections, a `r enforcementchange[1,5]`% change in enforcement fines, and a `r enforcementchange[1,6]`% change in enforcement actions.</h2>
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in SC3, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_SC-090220.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_SC-090220.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_SC-090220.csv`, `inspectionsper1000_All_pg4_SC-3`)
...
names(`violationsper1000_All_pg4_SC-090220.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_SC-090220.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_SC-090220.csv`, `violationsper1000_All_pg4_SC-3`)
...
#clean up data
#CWAviolations <- read.csv(here("SC3/violations_CWA_pg6_SC-3-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/SC3/jeff_duncan.png" style="float: left; width: 25%; margin-right: 5%" ></a>
...
<a href="https://www.environmentalenforcementwatch.org/"><img src="/Users/colealder/Documents/CD-report/reportcards/eew_logo.png" style="float: left; width: 25%; margin-left: 20%" ></a>

<a href="https://envirodatagov.org/"><img src="/Users/colealder/Documents/CD-report/reportcards/edgi_logo.png" style="float: right; width: 35%; margin-right: 20%" ></a>
