...
##### El estado de Wyoming; asiento ocupado por `r WY[1,2]` desde `r WY[1,8]` 
 <div class="container">
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="WY", "WY", "otros CDs/\nestados")
...
#removing NY9 and WA5 and MI7, WY, and IA2 and extra CA9
CWAper100 <- CWAper100[-c(37,51,28,14,53,8),]

WY_dot <- CWAper1000[which(CWAper1000$CD.State=="WY"), ]

##THIS CODE WILL NOT WORK FOR NY9 and WA5 and MI7, WY, and IA2. Omit this chunk of code for those districts (here to the end of this r chunk)
...
ggsave("dotplot_WY.png", dotplot, path=here("../CD_Dirs/WY"), scale = 2, width=9, height=5, units=c("cm"))
...
<h3>En WY, hubo <span style="color:#569b5e">`r WY_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
```
# ASPECTOS DESTACADOS DEL  ESTADO DE WYOMING
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/WY/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/WY/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/WY/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
## Ha estado en esta oficina `r WY[1,6]` `r WY[1,7]`, `r WY[1,8]`
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/WY_2020.pdf)
