...
##### El  distrito de Montana; asiento ocupado por `r MT[1,2]` desde `r MT[1,8]` 
 <div class="container">
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="MT", "MT", "otros CDs/\nestados")
...
ggsave("dotplot_MT.png", dotplot, path=here("../CD_Dirs/MT"), scale = 2, width=9, height=5, units=c("cm"))
...
<h3>En MT, hubo <span style="color:#569b5e">`r MT_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
#ok so We'll put the % in the title for the state, and try to figure out the same for MT 0
...
CAArecurring$Region2 <- as.character("All of MT")
...
CWArecurring$Region2 <- as.character("All of MT")
...
RCRArecurring$Region2 <- as.character("All of MT")
...
```
# ASPECTOS DESTACADOS DEL DISTRITO DE MONTANA
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MT/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MT/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MT/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
## Ha estado en esta oficina `r MT[1,6]` `r MT[1,7]`, `r MT[1,8]`
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/MT_2020.pdf)
