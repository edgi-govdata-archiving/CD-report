...
filenames = list.files(here("CA44"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CA44", i)))
}
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_CA-44`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in CA44, were in violation for at least 25% of the last 3 years.</h2>
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CA-090820.csv`, `inspectionsper1000_All_pg4_CA-44`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CA-090820.csv`, `violationsper1000_All_pg4_CA-44`)
...
#clean up data
#CWAviolations <- read.csv(here("CA44/violations_CWA_pg6_CA-44-090820.csv"), 
                          #header=FALSE)
