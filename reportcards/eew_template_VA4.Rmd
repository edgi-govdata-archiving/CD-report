...
effluentgraph <- ggplot(effluentviolations, mapping=aes(x=factor(Year),
  ...
  theme(axis.text.x=element_text(size=9),
        axis.title.x = element_blank(), plot.subtitle = element_text(hjust=.5), plot.title = element_text(lineheight = .1))
...
<h2>[`r VA4[1,2]`](`r VA4[1,7]`) <span style="color:#25539f">(`r VA4[1,3]`)</span></h2>
