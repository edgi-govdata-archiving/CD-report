...
<h2><span style="color:#e56d13">Clean Water Act Violations: `r vCWAchange[1,4]` `r vCWAchange[1,5]` than the previous 16 years, representing a `r vCWAchange[1,6]`% `r vCWAchange[1,7]` in violations</span></h2>

<h2><span style="color:#e56d13">Enforcement Actions under CAA, CWA, and RCRA: `r actionchange[1,4]` `r actionchange[1,5]` than the previous 16 years, representing a `r actionchange[1,6]`% `r actionchange[1,7]` in enforcement actions</span></h2>
