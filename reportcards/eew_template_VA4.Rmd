...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/VA4/VA4_map_2.png" alt="Snow" style="width:100%;">
...
## What is a "facility"? 
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/reportcards/facility.jpeg" style="float: center; width: 50%" ></a>
...
### Enforcement: Worse than Average

[Link to more thorough grade idea](https://docs.google.com/presentation/d/1F2npaSHOWNUaxurECWwoxOpBoAqmDbHDkozyfvavEyc/edit#slide=id.p) 
...
fineCAAgraph <- ggplot(CAAenforcement, mapping=aes(x=factor(Date), y=Amountinthousands, fill=President, group=1))+
  ...
  scale_fill_manual(values=c("#450d54", "#22908d", "#e56d13"))+
  labs(y=" Fines ($1000s)", x="Year", title="CAA Fines\n", subtitle ="Somewhat reliable data", caption="Values adjusted for inflation. Note, the y-axis reports values in\n1000's. A value of $2000 represents $2,000,000 (2 million dollars).")+
...
datacheck <-data.frame("Metric"=c("CWA self-reported violations","CWA, CAA, RCRA inspections; CAA, CWA, RCRA enforcement actions and penalties", "CAA Violations, RCRA violations"),
                          "Color"=c("Green (relatively good data)", "Yellow (data varies by state, from somewhat reliable to somewhat unreliable)", "Red (poor data that may be seriously misleading)"),
                          "Why"=c("Mandatory electronic self-reporting", "Unreliability of state reporting on inspections and enforcement actions", "Problems of self-reporting and unreliability of state reporting"))
