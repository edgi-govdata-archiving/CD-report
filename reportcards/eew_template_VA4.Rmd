...
<h4><span style="padding-left=100px">Page 1</span></h4>
...
<h3><span style="size=5em">Clean Water Act Violations:</span></h3> <span style="color=#569b5e">`r vCWAchange[1,4]` `r vCWAchange[1,5]`</span> than the previous 16 years, representing a <span style="color=#569b5e">`r vCWAchange[1,6]`% `r vCWAchange[1,7]` in violations</span></span></h3>

<br />

<h3><span style="size=5em">Enforcement Actions under CAA, CWA, and RCRA: `r actionchange[1,4]` `r actionchange[1,5]` than the previous 16 years, representing a `r actionchange[1,6]`% `r actionchange[1,7]` in enforcement actions</span></h3>
