...
##THIS CODE WILL NOT WORK FOR NY9 and WA5 and MI7, AK, and IA2. Please see the read.me to get the proper code for these districts/state
...
ggsave("dotplot_VA4.jpeg", dotplot, path=here("VA4"), scale = 2, width=8, height=5, units=c("cm"))
...
<h3>In VA4, there are <span style="color:#569b5e">`r VA4_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities</h3>
