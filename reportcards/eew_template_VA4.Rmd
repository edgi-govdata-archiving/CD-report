...
dotplot <-ggplot(CWAper100, aes(x=Region, y=Per100, fill=Highlight))+
  ...
  geom_text(aes(label="1 violation for\nevery facility", family="Georgia"),
            x=1.55, y=160, color="#e56d13", size=3)+
  theme_meg()+
  theme(axis.line.x=element_blank(), axis.title.x=element_blank(),
        legend.title = element_blank(), axis.text.x=element_text(size=10))


VA4_dot <- CWAper100[which(CWAper100$CD.State=="VA4"), ]


ggsave("dotplot_VA4.jpeg", dotplot, path=here("VA4"), scale = 2, width=7, height=5, units=c("cm"))

```
 
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/VA4/dotplot_VA4.jpeg" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>

<br />
<br />

<h3>In VA4, there are <span style="color:#569b5e">`r VA4_dot[1,6]`</span> Clean Water Act violations per 100 regulated facilities</h3>
...
This Committee is the oldest house Committee with the broadest jurisdiction of any authorizing committee. The Committee oversees the EPA, and legislates on issues such as environmental protection, clean air, climate change, safe drinking water, toxic chemicals and hazardous waste, and nuclear facilities. Currently, the Committee consists of 55 members – 24 Republicans and 31 Democrats. 
</div>
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/reportcards/datareliabilitytable.png" style="float: center; width: 100%" ></a>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>DRAFT not for circulation <span style="padding-left:450px">Page 11</span></h4>
...
<hr style="height:3px;border-width:0;color: #C1E0D7;background-color: #C1E0D7; margin-top: 2em">
<h4>DRAFT not for circulation <span style="padding-left:450px">Page 12</span></h4>
...
For access to the Jupyter Notebooks used to develop this report see our Github repository.(need to figure out which link)

For more on EEW see our website
