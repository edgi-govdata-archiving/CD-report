...
##### Michigan's 7th District; seat held by `r MI7[1,2]` since `r MI7[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="MI7", "MI7", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="MI7", "MI7", "Other")
...
<h3>In MI7, there were <span style="color:#569b5e">`r MI7_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
```
# Highlights for Michigan's 7th District
...
```
<a ><img src="../CD_Dirs/MI7/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MI7/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/MI7/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
## In office since `r MI7[1,6]` `r MI7[1,7]`, `r MI7[1,8]`
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/MI7_2020.pdf)
