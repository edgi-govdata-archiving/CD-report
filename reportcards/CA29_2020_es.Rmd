...
##### El 29$^\circ$ distrito de California; asiento ocupado por `r CA29[1,2]` desde `r CA29[1,8]` 
 <div class="container">
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="CA29", "CA29", "otros CDs/\nestados")
...
ggsave("dotplot_CA29.png", dotplot, path=here("../CD_Dirs/CA29"), scale = 2, width=9, height=5, units=c("cm"))
...
<h3>En CA29, hubo <span style="color:#569b5e">`r CA29_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
```
# ASPECTOS DESTACADOS DEL 29$^\circ$ DISTRITO DE CALIFORNIA
...
if ( nrows_caa > 0 ) {
  ...
  ggsave("CAAfacilities.png", CAAfacilities, path=here("../CD_Dirs/CA29"), scale = 3, width=7, height=4, units=c("cm"))
}
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/CA29/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/CA29/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/CA29/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
<h2>[`r CA29[1,2]`](`r CA29[1,9]`) (`r CA29[1,3]`)</h2>

## Ha estado en esta oficina `r CA29[1,6]` `r CA29[1,7]`, `r CA29[1,8]`
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/CA29_2020.pdf)
