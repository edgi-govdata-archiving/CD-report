...
##### El 4$^\circ$ distrito de Massachusetts; asiento ocupado por `r MA4[1,2]` desde `r MA4[1,8]` 
 <div class="container">
...
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="MA4", "MA4", "otros CDs/\nestados")
...
ggsave("dotplot_MA4.png", dotplot, path=here("../CD_Dirs/MA4"), scale = 2, width=9, height=5, units=c("cm"))
...
<h3>En MA4, hubo <span style="color:#569b5e">`r MA4_dot[1,5]`</span> violaciones de la Ley de Agua Limpia por cada 100 instalaciones reguladas en 2019.</h3>
...
```
# ASPECTOS DESTACADOS DEL 4$^\circ$ DISTRITO DE MASSACHUSETTS
...
`r if ( nrows_caa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MA4/CAAfacilities.png\" style=\"float: left; width: 55%; 
...
`r if ( nrows_rcra == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MA4/RCRAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
`r if ( nrows_cwa == 0) { 
    ...
    "<br /><a ><img src=\"../CD_Dirs/MA4/CWAfacilities.png\" style=\"float: left; width: 55%; 
      height: 60%; margin-right: 5%\" ></a>
    <font size=\"3\">**Informes de ECHO:**</font><font size=\"1.5\"><br />"
  }`
...
## Ha estado en esta oficina `r MA4[1,6]` `r MA4[1,7]`, `r MA4[1,8]`
...
[Enlace para descargar la versión PDF de este informe](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/MA4_2020.pdf)
