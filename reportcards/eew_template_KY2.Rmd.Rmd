...
```
 <div class="container">
  <img src="../CO1/CO1_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">Colorado's 1st District</div>
  <div class="middle-left">Seat held by Janice Schakowsky since 1999</div>
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in CO1, were in violation for at least 25% of the last 3 years.</h2>
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CO-090220.csv`, `inspectionsper1000_All_pg4_CO-1`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CO-090220.csv`, `violationsper1000_All_pg4_CO-1`)
...
#clean up data
#CWAviolations <- read.csv(here("CO1/violations_CWA_pg6_CO-1-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="../CO1/diana_degette.png" style="float: left; width: 25%; margin-right: 5%" ></a>
