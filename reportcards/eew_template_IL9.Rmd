...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in IL9, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_IL-090220.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_IL-090220.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_IL-090220.csv`, `inspectionsper1000_All_pg4_IL-9`)
...
names(`violationsper1000_All_pg4_IL-090220.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_IL-090220.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_IL-090220.csv`, `violationsper1000_All_pg4_IL-9`)
...
#clean up data
#CWAviolations <- read.csv(here("IL9/violations_CWA_pg6_IL-9-090220.csv"), 
                          #header=FALSE)
...
1. Chair, Consumer Protection and Commerce
