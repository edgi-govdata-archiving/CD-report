...
#national data
filenames = list.files(here("nationalstats_2"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*)_.*$","\\1", i)
  assign(name, read.csv(here("nationalstats_2", i)))
}
...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/IL9/IL9_map.png" alt="Snow" style="width:100%;">
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/IL9/janice_schakowsky.png" style="float: left; width: 25%; margin-right: 5%" ></a>
