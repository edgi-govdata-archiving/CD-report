...
filenames = list.files(here("CD_Dirs/NY9"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CD_Dirs/NY9", i)))
}
...
NY9 <- housemembers[which(housemembers$CD=="NY9"), ]
...
##### New York's 9th District; seat held by `r NY9[1,2]` since `r NY9[1,8]` 
 <div class="container">
  <img src="../CD_maps/NY9_map.png" alt="Snow" style="width:100%;">
...
NY9_dot <- CWAper1000[which(CWAper1000$CD.State=="NY9"), ]



```
 
<a ><img src="../CD_Dirs/NY9/dotplot_NY9.png" style="float: left; width: 100%; height: 60%; margin-right: 5%" ></a>
...
<h3>In NY9, there were <span style="color:#569b5e">`r NY9_dot[1,5]`</span> Clean Water Act violations per 100 regulated facilities in 2019.</h3>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `violations_CWA_pg3_NY-9`
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_NY-091820.csv`, `inspectionsper1000_All_pg4_NY-9`)
...
inspect1000bar <- ggplot(inspectionsper1000, aes(fill=Region, y=Inspectionsper1000, x=Program, alpha=Program))+
  ...
  scale_y_continuous(expand=c(0,0),limits=c(0,1200))+geom_hline(yintercept=1000, linetype="dashed", color="black")+geom_text(aes(label="Average of 1 inspection per facility",family="Georgia"),x=2,y=1100,color="black",size=4)+
  theme_meg()
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_NY-091820.csv`, `violationsper1000_All_pg4_NY-9`)
...
CAAbadactors <- `noncomp_CAA_pg6_NY-9`
...
#call in data and clean up 
CWAbadactors <- `noncomp_CWA_pg6_NY-9`
...
#call in data and clean up 
RCRAbadactors <- `noncomp_RCRA_pg7_NY-9`
...
ggsave("CAAfacilities.png", CAAfacilities, path=here("CD_Dirs/NY9"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("CWAfacilities.png", CWAfacilities, path=here("CD_Dirs/NY9"), scale = 3, width=7, height=4, units=c("cm"))
ggsave("RCRAfacilities.png", RCRAfacilities, path=here("CD_Dirs/NY9"), scale = 3, width=7, height=4, units=c("cm"))

```
<a ><img src="../CD_Dirs/NY9/CAAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/NY9/CWAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<a ><img src="../CD_Dirs/NY9/RCRAfacilities.png" style="float: left; width: 65%; height: 60%; margin-right: 5%" ></a>
...
<br />
<a ><img src="../CD_images/NY9_rep.png" style="float: left; width: 25%; margin-right: 5%" ></a>


<h2>[`r NY9[1,2]`](`r NY9[1,9]`) (`r NY9[1,3]`)</h2>

## In office since `r NY9[1,6]` `r NY9[1,7]`, `r NY9[1,8]`
...
<h4><span style="padding-left:30px">[`r NY9[1,10]`](`r NY9[1,11]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NY9[1,12]`](`r NY9[1,13]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NY9[1,14]`](`r NY9[1,15]`)</span></h4>

<br />

<h4><span style="padding-left:30px">[`r NY9[1,16]`](`r NY9[1,17]`)</span></h4>
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/NY9_2020.pdf)
