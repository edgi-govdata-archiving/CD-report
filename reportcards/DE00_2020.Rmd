...
##### Delaware's Congressional District; seat held by `r DE[1,2]` since `r DE[1,8]` 
 <div class="container">
...
CWAper10002$Highlight <- ifelse(CWAper10002$CD.State=="DE00", "DE", "Other")
CWAper1000$Highlight <- ifelse(CWAper1000$CD.State=="DE00", "DE", "Other")
...
[Link to download PDF version of this report](https://github.com/edgi-govdata-archiving/CD-report/blob/master/reportcards/DE00_2020.pdf)
