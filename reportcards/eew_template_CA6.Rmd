...
filenames = list.files(here("CA6"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CA6", i)))
}
...
```
 <div class="container">
  <img src="../CA6/CA6_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">California's 6th District</div>
  <div class="middle-left">Seat held by Doris O. Matsui since 2013</div>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_CA-6`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in CA6, were in violation for at least 25% of the last 3 years.</h2>
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CA-090820.csv`, `inspectionsper1000_All_pg4_CA-6`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CA-090820.csv`, `violationsper1000_All_pg4_CA-6`)
...
```{r, fig.height = 5, fig.width = 8, fig.align = "center"}
#clean up data
#CWAviolations <- read.csv(here("CA6/violations_CWA_pg6_CA-6-090820.csv"), 
                          #header=FALSE)
...
<a ><img src="../CA6/doris_matsui.png" style="float: left; width: 25%; margin-right: 5%" ></a>
