...
filenames = list.files(here("WV1"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/WV1/WV1_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">West Virginia's 1st District</div>
  <div class="middle-left">Seat held by David McKinley since 2001</div>
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in WV1, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_WV-090220.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_WV-090220.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_WV-090220.csv`, `inspectionsper1000_All_pg4_WV-1`)
...
names(`violationsper1000_All_pg4_WV-090220.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_WV-090220.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_WV-090220.csv`, `violationsper1000_All_pg4_WV-1`)
...
#clean up data
#CWAviolations <- read.csv(here("WV1/violations_CWA_pg6_WV-1-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/WV1/david_mckinley.png" style="float: left; width: 25%; margin-right: 5%" ></a>

<h2><span style="color:#C21807">Republican</span></h2>
## In office since January 5th, 2001
