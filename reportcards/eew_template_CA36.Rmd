...
filenames = list.files(here("CA36"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("CA36", i)))
}
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_CA-36`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in CA36, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_CA-090220.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_CA-090220.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CA-090220.csv`, `inspectionsper1000_All_pg4_CA-36`)
...
names(`violationsper1000_All_pg4_CA-090220.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_CA-090220.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CA-090220.csv`, `violationsper1000_All_pg4_CA-36`)
...
#clean up data
#CWAviolations <- read.csv(here("CA36/violations_CWA_pg6_CA-36-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/CA36/raul_ruiz.png" style="float: left; width: 25%; margin-right: 5%" ></a>
...
1. Vice Chair, Environment and Climate Change
2. Health
