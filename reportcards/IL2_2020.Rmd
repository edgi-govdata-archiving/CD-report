...
##### Illinois' 2nd District; seat held by `r IL2[1,2]` since `r IL2[1,8]` 
 <div class="container">
...
```
# Highlights for Illinois' 2nd District
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_CA-091820.csv`, `inspectionsper1000_All_pg4_IL-2`)
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_CA-091820.csv`, `violationsper1000_All_pg4_IL-2`)
