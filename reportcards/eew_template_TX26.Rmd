...
filenames = list.files(here("TX26"), pattern = ".csv")
file_count = length(filenames)
for (i in filenames){  
  name <- gsub("^([^_]*_[^_]*_[^_]*_[^-]*-[^-]*)-.*$","\\1", i)
  assign(name, read.csv(here("TX26", i)))
}
...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/TX26/TX26_map.png" alt="Snow" style="width:100%;">
  <div class="top-left">Texas' 26th District</div>
  <div class="middle-left">Seat held by Michael Burgess since 2003</div>
...
#[9:11,2] Obama
# [17:19,2] Trump
effluentviolations <- `effluent-violations_CWA_pg3_TX-26`
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in TX26, were in violation for at least 25% of the last 3 years.</h2>
...
names(`inspectionsper1000_All_pg4_TX-090220.csv`)[2] <- "Inspectionsper1000"
`inspectionsper1000_All_pg4_TX-090220.csv`$Region <- as.factor("State")
...
inspectionsper1000 <- rbind(USAinspectionsper1000_All, `inspectionsper1000_All_pg4_TX-090220.csv`, `inspectionsper1000_All_pg4_TX-26`)
...
names(`violationsper1000_All_pg4_TX-090220.csv`)[2] <- "violationsper1000"
`violationsper1000_All_pg4_TX-090220.csv`$Region <- as.factor("State")
...
violationsper1000 <- rbind(USAviolationsper1000_All, `violationsper1000_All_pg4_TX-090220.csv`, `violationsper1000_All_pg4_TX-26`)
...
#clean up data
#CWAviolations <- read.csv(here("TX26/violations_CWA_pg6_TX-26-090220.csv"), 
                          #header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/TX26/michael_burgess.png" style="float: left; width: 25%; margin-right: 5%" ></a>

<h2><span style="color:#C21807">Republican</span></h2>
## In office since January 7th, 2003
