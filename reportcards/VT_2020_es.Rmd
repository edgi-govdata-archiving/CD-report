...
##### El estado de Vermont; asiento ocupado por `r VT[1,2]` desde `r VT[1,8]` 
 <div class="container">
...
#removing NY9 and WA5 and MI7, VT, and IA2 and extra CA9
CWAper100 <- CWAper100[-c(37,51,28,14,53,8),]

VT_dot <- CWAper1000[which(CWAper1000$CD.State=="VT"), ]

##THIS CODE WILL NOT WORK FOR NY9 and WA5 and MI7, VT, and IA2. Omit this chunk of code for those districts (here to the end of this r chunk)
...
```
# ASPECTOS DESTACADOS DEL  ESTADO DE VERMONT
