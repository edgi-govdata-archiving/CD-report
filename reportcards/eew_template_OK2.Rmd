...
```
 <div class="container">
  <img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/OK2/OK2_map.png" alt="Snow" style="width:100%;">
...
* <h2>Under the Clean Water Act, the only well-reported regulation in this report, `r CWArecurring[2,2]` facilities, representing `r CWArecurring[2,3]`% of all regulated facilities in OK2, were in violation for at least 25% of the last 3 years.</h2>
...
#clean up data
#CWAviolations <- read.csv(here("OK2/violations_CWA_pg6_OK-2-090220.csv"), 
                         # header=FALSE)
...
<a ><img src="/Users/mraisle/Documents/OneDrive - University of North Carolina at Chapel Hill/CD-report/OK2/markwayne_mullin.png" style="float: left; width: 25%; margin-right: 5%" ></a>
